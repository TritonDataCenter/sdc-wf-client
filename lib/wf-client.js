 ...
 *
 * - createJob(wf, params, headers, cb)
 * - createJob(params, headers, cb)
 *
 * Headers is an optional arg in both cases so the functions would normally
 * take this form:
 *
 ...
 * @param headers {Object} Optional. Additional request headers to pass.
 * @param cb {Function} Callback of the form fb(err, job).
 */
WfClient.prototype.createJob = function () {
    var wf, params, headers, cb, opts;
